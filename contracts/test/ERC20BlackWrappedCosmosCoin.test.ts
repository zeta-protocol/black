...
import {
  ...
  ERC20BlackWrappedCosmosCoin__factory as ERC20BlackWrappedCosmosCoinFactory,
} from "../typechain-types";

const decimals = 6n;

describe("ERC20BlackWrappedCosmosCoin", function () {
  let erc20: ERC20BlackWrappedCosmosCoin;
  let erc20Factory: ERC20BlackWrappedCosmosCoinFactory;
  let owner: Signer;
  let sender: Signer;
