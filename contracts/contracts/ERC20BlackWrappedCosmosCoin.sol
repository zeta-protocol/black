...
/// @title An ERC20 token contract owned and deployed by the evmutil module of Black.
///        Tokens are backed one-for-one by cosmos-sdk coins held in the module account.
/// @author Black Labs, LLC
/// @custom:security-contact security@black.io
contract ERC20BlackWrappedCosmosCoin is ERC20, Ownable {
