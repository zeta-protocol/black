...
import (
	...
	evmutiltestutil "github.com/zeta-protocol/black/x/evmutil/testutil"
...
func (suite *EIP712TestSuite) SetupTest() {
	...
	// funds our test accounts with some ublack
	...
	params.EIP712AllowedMsgs = []evmtypes.EIP712AllowedMsg{
		{
			MsgTypeUrl:       "/black.evmutil.v1beta1.MsgConvertERC20ToCoin",
			MsgValueTypeName: "MsgValueEVMConvertERC20ToCoin",
			ValueTypes: []evmtypes.EIP712MsgAttrType{
				{Name: "initiator", Type: "string"},
				{Name: "receiver", Type: "string"},
				{Name: "black_erc20_address", Type: "string"},
				{Name: "amount", Type: "string"},
			},
		},
		{
			MsgTypeUrl:       "/black.cdp.v1beta1.MsgCreateCDP",
		...
		{
			MsgTypeUrl:       "/black.cdp.v1beta1.MsgDeposit",
		...
		{
			MsgTypeUrl:       "/black.hard.v1beta1.MsgDeposit",
		...
		{
			MsgTypeUrl:       "/black.evmutil.v1beta1.MsgConvertCoinToERC20",
		...
		{
			MsgTypeUrl:       "/black.cdp.v1beta1.MsgRepayDebt",
		...
		{
			MsgTypeUrl:       "/black.hard.v1beta1.MsgWithdraw",
	...
	testcases := []struct {
		...
		},
		{
			...
			updateTx: func(txBuilder client.TxBuilder, msgs []sdk.Msg) client.TxBuilder {
				...
				gasCoins := bk.GetBalance(suite.ctx, suite.testAddr, "ublack")
		...
		},
		{
			...
			updateTx: func(txBuilder client.TxBuilder, msgs []sdk.Msg) client.TxBuilder {
				gasAmt := sdk.NewCoins(sdk.NewCoin("ublack", sdkmath.NewInt(20)))
				return suite.createTestEIP712CosmosTxBuilder(
					suite.testAddr, suite.testPrivKey, "blacktest_12-1", uint64(helpers.DefaultGenTxGas*10), gasAmt, msgs,
				)
			},
		},
		{
