...
func (suite *tallyHandlerSuite) SetupTest() {
	...
	suite.staking.setBondDenom(suite.ctx, "ublack")
...
func (suite *tallyHandlerSuite) TestVotePower_UserOverridesValidator() {
	...
	// Validator votes, inheriting user's stake and bblack.
...
func (suite *tallyHandlerSuite) allowBBlackEarnDeposits() {
