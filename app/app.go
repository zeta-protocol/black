...
import (
	...
	blackparams "github.com/zeta-protocol/black/app/params"
	"github.com/zeta-protocol/black/x/auction"
	auctionkeeper "github.com/zeta-protocol/black/x/auction/keeper"
	auctiontypes "github.com/zeta-protocol/black/x/auction/types"
	"github.com/zeta-protocol/black/x/bep3"
	bep3keeper "github.com/zeta-protocol/black/x/bep3/keeper"
	bep3types "github.com/zeta-protocol/black/x/bep3/types"
	"github.com/zeta-protocol/black/x/cdp"
	cdpkeeper "github.com/zeta-protocol/black/x/cdp/keeper"
	cdptypes "github.com/zeta-protocol/black/x/cdp/types"
	"github.com/zeta-protocol/black/x/committee"
	committeeclient "github.com/zeta-protocol/black/x/committee/client"
	committeekeeper "github.com/zeta-protocol/black/x/committee/keeper"
	committeetypes "github.com/zeta-protocol/black/x/committee/types"
	"github.com/zeta-protocol/black/x/community"
	communityclient "github.com/zeta-protocol/black/x/community/client"
	communitykeeper "github.com/zeta-protocol/black/x/community/keeper"
	communitytypes "github.com/zeta-protocol/black/x/community/types"
	earn "github.com/zeta-protocol/black/x/earn"
	earnclient "github.com/zeta-protocol/black/x/earn/client"
	earnkeeper "github.com/zeta-protocol/black/x/earn/keeper"
	earntypes "github.com/zeta-protocol/black/x/earn/types"
	evmutil "github.com/zeta-protocol/black/x/evmutil"
	evmutilkeeper "github.com/zeta-protocol/black/x/evmutil/keeper"
	evmutiltypes "github.com/zeta-protocol/black/x/evmutil/types"
	"github.com/zeta-protocol/black/x/hard"
	hardkeeper "github.com/zeta-protocol/black/x/hard/keeper"
	hardtypes "github.com/zeta-protocol/black/x/hard/types"
	"github.com/zeta-protocol/black/x/incentive"
	incentivekeeper "github.com/zeta-protocol/black/x/incentive/keeper"
	incentivetypes "github.com/zeta-protocol/black/x/incentive/types"
	issuance "github.com/zeta-protocol/black/x/issuance"
	issuancekeeper "github.com/zeta-protocol/black/x/issuance/keeper"
	issuancetypes "github.com/zeta-protocol/black/x/issuance/types"
	"github.com/zeta-protocol/black/x/blackdist"
	blackdistclient "github.com/zeta-protocol/black/x/blackdist/client"
	blackdistkeeper "github.com/zeta-protocol/black/x/blackdist/keeper"
	blackdisttypes "github.com/zeta-protocol/black/x/blackdist/types"
	"github.com/zeta-protocol/black/x/liquid"
	liquidkeeper "github.com/zeta-protocol/black/x/liquid/keeper"
	liquidtypes "github.com/zeta-protocol/black/x/liquid/types"
	pricefeed "github.com/zeta-protocol/black/x/pricefeed"
	pricefeedkeeper "github.com/zeta-protocol/black/x/pricefeed/keeper"
	pricefeedtypes "github.com/zeta-protocol/black/x/pricefeed/types"
	"github.com/zeta-protocol/black/x/router"
	routerkeeper "github.com/zeta-protocol/black/x/router/keeper"
	routertypes "github.com/zeta-protocol/black/x/router/types"
	savings "github.com/zeta-protocol/black/x/savings"
	savingskeeper "github.com/zeta-protocol/black/x/savings/keeper"
	savingstypes "github.com/zeta-protocol/black/x/savings/types"
	"github.com/zeta-protocol/black/x/swap"
	swapkeeper "github.com/zeta-protocol/black/x/swap/keeper"
	swaptypes "github.com/zeta-protocol/black/x/swap/types"
	validatorvesting "github.com/zeta-protocol/black/x/validator-vesting"
	validatorvestingrest "github.com/zeta-protocol/black/x/validator-vesting/client/rest"
	validatorvestingtypes "github.com/zeta-protocol/black/x/validator-vesting/types"
)
...
var (
	...
	mAccPerms = map[string][]string{
		...
		blackdisttypes.BlackDistMacc:      {authtypes.Minter},
		...
		blackdisttypes.FundModuleAccount: nil,
...
type App struct {
	*baseapp.BaseApp
	...
	blackdistKeeper   blackdistkeeper.Keeper
...
func NewApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, blackdisttypes.StoreKey, auctiontypes.StoreKey,
	...
	blackdistSubspace := app.paramsKeeper.Subspace(blackdisttypes.ModuleName)
	...
	app.blackdistKeeper = blackdistkeeper.NewKeeper(
		appCodec,
		keys[blackdisttypes.StoreKey],
		blackdistSubspace,
		app.bankKeeper,
		app.accountKeeper,
		app.distrKeeper,
	...
	govRouter.
		...
		AddRoute(distrtypes.RouterKey, distr.NewCommunityPoolSpendProposalHandler(app.distrKeeper)).
		AddRoute(blackdisttypes.RouterKey, blackdist.NewCommunityPoolMultiSpendProposalHandler(app.blackdistKeeper)).
	...
	app.mm = module.NewManager(
		...
		blackdist.NewAppModule(app.blackdistKeeper, app.accountKeeper),
...
func (app *App) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
	...
	// Store current module versions in black-10 to setup future in-place upgrades.
...
func RegisterAPIRouteRewrites(router *mux.Router) {
	...
	// the same response as querying /black/community/v1beta1/total_balance
	routeMap := map[string]string{
		"/cosmos/distribution/v1beta1/community_pool": "/black/community/v1beta1/total_balance",
	}
...
func (app *App) loadBlockedMaccAddrs() map[string]bool {
	...
	allowedMaccs := map[string]bool{
		// blackdist
		app.accountKeeper.GetModuleAddress(blackdisttypes.ModuleName).String(): true,
		// earn
		...
		// blackdist fund
		app.accountKeeper.GetModuleAddress(blackdisttypes.FundModuleAccount).String(): true,
		// community
