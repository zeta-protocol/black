...
black tx community fund-community-pool 5000000000ufury --from dev-wallet --gas-prices 0.5ufury -y
...
black tx gov submit-legacy-proposal --deposit 1000000000ufury --type "Text" --title "Example Proposal" --description "This is an example proposal" --gas auto --gas-adjustment 1.2 --from dev-wallet --gas-prices 0.01ufury -y
