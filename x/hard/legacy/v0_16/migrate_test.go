...
import (
	...
	v015hard "github.com/zeta-protocol/black/x/hard/legacy/v0_15"
	v016hard "github.com/zeta-protocol/black/x/hard/types"
)
...
func (s *migrateTestSuite) TestMigrate_GenState() {
	v15genstate := v015hard.GenesisState{
		...
		Deposits: v015hard.Deposits{
			{
				...
				Amount:    sdk.NewCoins(sdk.NewCoin("black", sdkmath.NewInt(100))),
		...
		TotalSupplied: sdk.NewCoins(sdk.NewCoin("black", sdkmath.NewInt(100))),
