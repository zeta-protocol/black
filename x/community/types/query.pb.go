...
func init() {
	proto.RegisterType((*QueryBalanceRequest)(nil), "black.community.v1beta1.QueryBalanceRequest")
	proto.RegisterType((*QueryBalanceResponse)(nil), "black.community.v1beta1.QueryBalanceResponse")
	proto.RegisterType((*QueryTotalBalanceRequest)(nil), "black.community.v1beta1.QueryTotalBalanceRequest")
	proto.RegisterType((*QueryTotalBalanceResponse)(nil), "black.community.v1beta1.QueryTotalBalanceResponse")
}

func init() {
	proto.RegisterFile("black/community/v1beta1/query.proto", fileDescriptor_f236f06c43149273)
}
...
func (c *queryClient) Balance(ctx context.Context, in *QueryBalanceRequest, opts ...grpc.CallOption) (*QueryBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.community.v1beta1.Query/Balance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalBalance(ctx context.Context, in *QueryTotalBalanceRequest, opts ...grpc.CallOption) (*QueryTotalBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.community.v1beta1.Query/TotalBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.community.v1beta1.Query/Balance",
	}
...
func _Query_TotalBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.community.v1beta1.Query/TotalBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.community.v1beta1.Query",
	...
	Metadata: "black/community/v1beta1/query.proto",
}
