...
// source: black/community/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*CommunityPoolLendDepositProposal)(nil), "black.community.v1beta1.CommunityPoolLendDepositProposal")
	proto.RegisterType((*CommunityPoolLendWithdrawProposal)(nil), "black.community.v1beta1.CommunityPoolLendWithdrawProposal")
	proto.RegisterType((*CommunityCDPRepayDebtProposal)(nil), "black.community.v1beta1.CommunityCDPRepayDebtProposal")
	proto.RegisterType((*CommunityCDPWithdrawCollateralProposal)(nil), "black.community.v1beta1.CommunityCDPWithdrawCollateralProposal")
}

func init() {
	proto.RegisterFile("black/community/v1beta1/proposal.proto", fileDescriptor_64aa83b2ed448ec1)
}
