...
func init() {
	...
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityPoolLendDepositProposal{}, "black/CommunityPoolLendDepositProposal", nil)
	govv1beta1.RegisterProposalType(ProposalTypeCommunityPoolLendWithdraw)
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityPoolLendWithdrawProposal{}, "black/CommunityPoolLendWithdrawProposal", nil)
	govv1beta1.RegisterProposalType(ProposalTypeCommunityCDPRepayDebt)
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityCDPRepayDebtProposal{}, "black/CommunityCDPRepayDebtProposal", nil)
	govv1beta1.RegisterProposalType(ProposalTypeCommunityCDPWithdrawCollateral)
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityCDPWithdrawCollateralProposal{}, "black/CommunityCDPWithdrawCollateralProposal", nil)
}
