...
// source: black/community/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgFundCommunityPool)(nil), "black.community.v1beta1.MsgFundCommunityPool")
	proto.RegisterType((*MsgFundCommunityPoolResponse)(nil), "black.community.v1beta1.MsgFundCommunityPoolResponse")
}

func init() { proto.RegisterFile("black/community/v1beta1/tx.proto", fileDescriptor_e81067e0fbdaca18) }
...
func (c *msgClient) FundCommunityPool(ctx context.Context, in *MsgFundCommunityPool, opts ...grpc.CallOption) (*MsgFundCommunityPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.community.v1beta1.Msg/FundCommunityPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_FundCommunityPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.community.v1beta1.Msg/FundCommunityPool",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.community.v1beta1.Msg",
	...
	Metadata: "black/community/v1beta1/tx.proto",
}
