...
import (
	...
	v015issuance "github.com/zeta-protocol/black/x/issuance/legacy/v0_15"
	v016issuance "github.com/zeta-protocol/black/x/issuance/types"
)
...
func (s *migrateTestSuite) TestMigrate_JSON() {
	...
	data := `{
			...
			"assets": [
				{
					...
					"denom": "hbtc",
					"owner": "black1dmm9zpdnm6mfhywzt9sstm4p33y0cnsd0m673z",
					"paused": false,
					"rate_limit": {
						"active": false,
						"limit": "0",
		...
		"supplies": [
			{
				"current_supply": { "denom": "ublack", "amount": "100" },
...
func (s *migrateTestSuite) TestMigrate_Supplies() {
	s.v15genstate.Supplies = v015issuance.AssetSupplies{
		{
			CurrentSupply: sdk.NewCoin("ublack", sdkmath.NewInt(100)),
