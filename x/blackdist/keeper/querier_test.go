...
// 	sk.MintCoins(suite.ctx, types.BlackDistMacc, sdk.NewCoins(sdk.NewCoin("ublack", sdkmath.NewInt(100e6))))
...
// 	suite.Require().Equal(sdkmath.NewInt(100e6), coins.AmountOf("ublack"))
// }
