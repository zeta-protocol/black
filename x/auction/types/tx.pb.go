...
// source: black/auction/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgPlaceBid)(nil), "black.auction.v1beta1.MsgPlaceBid")
	proto.RegisterType((*MsgPlaceBidResponse)(nil), "black.auction.v1beta1.MsgPlaceBidResponse")
}

func init() { proto.RegisterFile("black/auction/v1beta1/tx.proto", fileDescriptor_226282be4da73be5) }
...
func (c *msgClient) PlaceBid(ctx context.Context, in *MsgPlaceBid, opts ...grpc.CallOption) (*MsgPlaceBidResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.auction.v1beta1.Msg/PlaceBid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.auction.v1beta1.Msg/PlaceBid",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.auction.v1beta1.Msg",
	...
	Metadata: "black/auction/v1beta1/tx.proto",
}
