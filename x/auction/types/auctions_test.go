...
const (
	...
	testAccAddress1         = "black1qcfdf69js922qrdr4yaww3ax7gjml6pd39p8lj"
	testAccAddress2         = "black1pdfav2cjhry9k79nu6r8kgknnjtq6a7rcr0qlr"
)

func init() {
	sdk.GetConfig().SetBech32PrefixForAccount("black", "black"+sdk.PrefixPublic)
}
