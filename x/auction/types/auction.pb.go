...
// source: black/auction/v1beta1/auction.proto
...
func init() {
	proto.RegisterType((*BaseAuction)(nil), "black.auction.v1beta1.BaseAuction")
	proto.RegisterType((*SurplusAuction)(nil), "black.auction.v1beta1.SurplusAuction")
	proto.RegisterType((*DebtAuction)(nil), "black.auction.v1beta1.DebtAuction")
	proto.RegisterType((*CollateralAuction)(nil), "black.auction.v1beta1.CollateralAuction")
	proto.RegisterType((*WeightedAddresses)(nil), "black.auction.v1beta1.WeightedAddresses")
}

func init() {
	proto.RegisterFile("black/auction/v1beta1/auction.proto", fileDescriptor_b9b5dac2c776ef9e)
}
