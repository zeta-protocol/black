...
// source: black/pricefeed/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgPostPrice)(nil), "black.pricefeed.v1beta1.MsgPostPrice")
	proto.RegisterType((*MsgPostPriceResponse)(nil), "black.pricefeed.v1beta1.MsgPostPriceResponse")
}

func init() { proto.RegisterFile("black/pricefeed/v1beta1/tx.proto", fileDescriptor_afd93c8e4685da16) }
...
func (c *msgClient) PostPrice(ctx context.Context, in *MsgPostPrice, opts ...grpc.CallOption) (*MsgPostPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.pricefeed.v1beta1.Msg/PostPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PostPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.pricefeed.v1beta1.Msg/PostPrice",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.pricefeed.v1beta1.Msg",
	...
	Metadata: "black/pricefeed/v1beta1/tx.proto",
}
