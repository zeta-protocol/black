...
func (suite *proposalTestSuite) TestCommunityDepositProposal() {
	...
	fundAmount := sdk.NewCoins(sdk.NewInt64Coin("ublack", 100000000))
	depositAmount := sdk.NewCoin("ublack", sdkmath.NewInt(10000000))
	...
	suite.CreateVault("ublack", types.StrategyTypes{types.STRATEGY_TYPE_SAVINGS}, false, nil)
