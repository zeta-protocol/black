...
// source: black/earn/v1beta1/query.proto
...
type VaultResponse struct {
	...
	Strategies StrategyTypes `protobuf:"varint,2,rep,packed,name=strategies,proto3,enum=black.earn.v1beta1.StrategyType,castrepeated=StrategyTypes" json:"strategies,omitempty"`
...
type QueryDepositsRequest struct {
	...
	// respond with vault value in ublack for bblack vaults
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "black.earn.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "black.earn.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryVaultsRequest)(nil), "black.earn.v1beta1.QueryVaultsRequest")
	proto.RegisterType((*QueryVaultsResponse)(nil), "black.earn.v1beta1.QueryVaultsResponse")
	proto.RegisterType((*QueryVaultRequest)(nil), "black.earn.v1beta1.QueryVaultRequest")
	proto.RegisterType((*QueryVaultResponse)(nil), "black.earn.v1beta1.QueryVaultResponse")
	proto.RegisterType((*VaultResponse)(nil), "black.earn.v1beta1.VaultResponse")
	proto.RegisterType((*QueryDepositsRequest)(nil), "black.earn.v1beta1.QueryDepositsRequest")
	proto.RegisterType((*QueryDepositsResponse)(nil), "black.earn.v1beta1.QueryDepositsResponse")
	proto.RegisterType((*DepositResponse)(nil), "black.earn.v1beta1.DepositResponse")
	proto.RegisterType((*QueryTotalSupplyRequest)(nil), "black.earn.v1beta1.QueryTotalSupplyRequest")
	proto.RegisterType((*QueryTotalSupplyResponse)(nil), "black.earn.v1beta1.QueryTotalSupplyResponse")
}

func init() { proto.RegisterFile("black/earn/v1beta1/query.proto", fileDescriptor_63f8dee2f3192a6b) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.earn.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Vaults(ctx context.Context, in *QueryVaultsRequest, opts ...grpc.CallOption) (*QueryVaultsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.earn.v1beta1.Query/Vaults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Vault(ctx context.Context, in *QueryVaultRequest, opts ...grpc.CallOption) (*QueryVaultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.earn.v1beta1.Query/Vault", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Deposits(ctx context.Context, in *QueryDepositsRequest, opts ...grpc.CallOption) (*QueryDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.earn.v1beta1.Query/Deposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalSupply(ctx context.Context, in *QueryTotalSupplyRequest, opts ...grpc.CallOption) (*QueryTotalSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.earn.v1beta1.Query/TotalSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.earn.v1beta1.Query/Params",
	}
...
func _Query_Vaults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.earn.v1beta1.Query/Vaults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Vault_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.earn.v1beta1.Query/Vault",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Deposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.earn.v1beta1.Query/Deposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TotalSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.earn.v1beta1.Query/TotalSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.earn.v1beta1.Query",
	...
	Metadata: "black/earn/v1beta1/query.proto",
}
