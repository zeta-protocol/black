...
func init() {
	...
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityPoolDepositProposal{}, "black/CommunityPoolDepositProposal", nil)
	govv1beta1.RegisterProposalType(ProposalTypeCommunityPoolWithdraw)
	govv1beta1.ModuleCdc.Amino.RegisterConcrete(&CommunityPoolWithdrawProposal{}, "black/CommunityPoolWithdrawProposal", nil)
}
