...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&CommunityPoolDepositProposal{}, "black/CommunityPoolDepositProposal", nil)
	cdc.RegisterConcrete(&CommunityPoolWithdrawProposal{}, "black/CommunityPoolWithdrawProposal", nil)
}
