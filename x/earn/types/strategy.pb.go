...
// source: black/earn/v1beta1/strategy.proto
...
func init() {
	proto.RegisterEnum("black.earn.v1beta1.StrategyType", StrategyType_name, StrategyType_value)
}

func init() { proto.RegisterFile("black/earn/v1beta1/strategy.proto", fileDescriptor_257c4968dd48fa09) }
