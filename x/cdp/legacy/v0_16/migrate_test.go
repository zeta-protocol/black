...
import (
	...
	v015cdp "github.com/zeta-protocol/black/x/cdp/legacy/v0_15"
	v016cdp "github.com/zeta-protocol/black/x/cdp/types"
)
	...
	s.v15genstate = v015cdp.GenesisState{
		...
		Deposits: v015cdp.Deposits{
			...
			},
			{
				...
				Amount:    sdk.NewCoin("ublack", sdkmath.NewInt(1200)),
			},
		},
		PreviousAccumulationTimes: v015cdp.GenesisAccumulationTimes{
			{
