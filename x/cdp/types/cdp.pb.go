...
// source: black/cdp/v1beta1/cdp.proto
...
func init() {
	proto.RegisterType((*CDP)(nil), "black.cdp.v1beta1.CDP")
	proto.RegisterType((*Deposit)(nil), "black.cdp.v1beta1.Deposit")
	proto.RegisterType((*TotalPrincipal)(nil), "black.cdp.v1beta1.TotalPrincipal")
	proto.RegisterType((*TotalCollateral)(nil), "black.cdp.v1beta1.TotalCollateral")
	proto.RegisterType((*OwnerCDPIndex)(nil), "black.cdp.v1beta1.OwnerCDPIndex")
}

func init() { proto.RegisterFile("black/cdp/v1beta1/cdp.proto", fileDescriptor_68a9ab097fb7be40) }
