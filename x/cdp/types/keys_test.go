...
func TestCollateralRatioKey(t *testing.T) {
	collateralKey := CollateralRatioKey("black-a", 2, sdk.MustNewDecFromStr("1.50"))
...
func TestCollateralRatioKey_BigRatio(t *testing.T) {
	...
	collateralKey := CollateralRatioKey("black-a", 2, bigRatio)
	collateralType, id, ratio := SplitCollateralRatioKey(collateralKey)
	require.Equal(t, "black-a", collateralType)
	require.Equal(t, 2, int(id))
...
func TestCollateralRatioIterKey(t *testing.T) {
	collateralIterKey := CollateralRatioIterKey("black-a", sdk.MustNewDecFromStr("1.50"))
