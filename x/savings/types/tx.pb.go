...
// source: black/savings/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgDeposit)(nil), "black.savings.v1beta1.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "black.savings.v1beta1.MsgDepositResponse")
	proto.RegisterType((*MsgWithdraw)(nil), "black.savings.v1beta1.MsgWithdraw")
	proto.RegisterType((*MsgWithdrawResponse)(nil), "black.savings.v1beta1.MsgWithdrawResponse")
}

func init() { proto.RegisterFile("black/savings/v1beta1/tx.proto", fileDescriptor_c0bf8679b144267a) }
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.savings.v1beta1.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Withdraw(ctx context.Context, in *MsgWithdraw, opts ...grpc.CallOption) (*MsgWithdrawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.savings.v1beta1.Msg/Withdraw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.savings.v1beta1.Msg/Deposit",
	}
...
func _Msg_Withdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.savings.v1beta1.Msg/Withdraw",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.savings.v1beta1.Msg",
	...
	Metadata: "black/savings/v1beta1/tx.proto",
}
