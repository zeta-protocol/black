...
import (
	...
	v015swap "github.com/zeta-protocol/black/x/swap/legacy/v0_15"
	v016swap "github.com/zeta-protocol/black/x/swap/types"
)
...
func (s *migrateTestSuite) TestMigrate_PoolRecords() {
	s.v15genstate.PoolRecords = v015swap.PoolRecords{
		...
		},
		{
			...
			ReservesB:   sdk.NewCoin("ublack", sdkmath.NewInt(500)),
