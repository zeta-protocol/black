...
func TestState_ShareRecord_Validations(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErr: "depositor 'black1mq9qxlhze029lm0frzw2xr6hem8c3k9ts54w0w' and pool 'ufury:usdx' has invalid total shares: -1",
		},
		{
			name:        "zero total shares",
			depositor:   validRecord.Depositor,
			...
			expectedErr: "depositor 'black1mq9qxlhze029lm0frzw2xr6hem8c3k9ts54w0w' and pool 'ufury:usdx' has invalid total shares: 0",
		},
	}
...
func TestState_ShareRecords_ValidateUniqueShareRecords(t *testing.T) {
	...
	assert.EqualError(t, invalidRecords.Validate(), "duplicate depositor 'black1mq9qxlhze029lm0frzw2xr6hem8c3k9ts54w0w' and poolID 'ufury:usdx'")
}
