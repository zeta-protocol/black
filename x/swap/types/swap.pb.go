...
// source: black/swap/v1beta1/swap.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "black.swap.v1beta1.Params")
	proto.RegisterType((*AllowedPool)(nil), "black.swap.v1beta1.AllowedPool")
	proto.RegisterType((*PoolRecord)(nil), "black.swap.v1beta1.PoolRecord")
	proto.RegisterType((*ShareRecord)(nil), "black.swap.v1beta1.ShareRecord")
}

func init() { proto.RegisterFile("black/swap/v1beta1/swap.proto", fileDescriptor_9df359be90eb28cb) }
