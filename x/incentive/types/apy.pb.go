...
// source: black/incentive/v1beta1/apy.proto
...
func init() {
	proto.RegisterType((*Apy)(nil), "black.incentive.v1beta1.Apy")
}

func init() { proto.RegisterFile("black/incentive/v1beta1/apy.proto", fileDescriptor_b2c1ad571f25cae9) }
