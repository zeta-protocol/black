...
func (suite *IntegrationTester) MintLiquidAnyValAddr(
	...
	if !found {
		// Create validator
		if err := suite.DeliverMsgCreateValidator(validator, sdk.NewCoin("ublack", sdkmath.NewInt(1e9))); err != nil {
			return sdk.Coin{}, err
		}
...
func (suite *IntegrationTester) GetBeginBlockClaimedStakingRewards(
	...
	for _, event := range resBeginBlock.Events {
		...
		// - amount:
		// - validator: blackvaloper1em2mlkrkx0qsa6327tgvl3g0fh8a95hjnqvrwh
		// Event: withdraw_rewards
		// - amount: 523909ublack
		// - validator: blackvaloper1nmgpgr8l4t8pw9zqx9cltuymvz85wmw9sy8kjy
