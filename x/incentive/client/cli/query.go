...
func queryRewardsCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: strings.TrimSpace(
			...
			$ %[1]s query %[2]s rewards --owner black15qdefkmwswysgg4qxgqpqr35k3m49pkx2jdfnw
			...
			$ %[1]s query %[2]s rewards --type hard --owner black15qdefkmwswysgg4qxgqpqr35k3m49pkx2jdfnw
