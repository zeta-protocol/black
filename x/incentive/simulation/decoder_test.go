...
func TestDecodeDistributionStore(t *testing.T) {
	cdc := makeTestCodec()
	addr, _ := sdk.AccAddressFromBech32("black15qdefkmwswysgg4qxgqpqr35k3m49pkx2jdfnw")
	claim := types.NewUSDXMintingClaim(addr, sdk.NewCoin("ublack", sdkmath.NewInt(1000000)), types.RewardIndexes{types.NewRewardIndex("bnb-a", sdk.ZeroDec())})
