...
// source: black/evmutil/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgConvertCoinToERC20)(nil), "black.evmutil.v1beta1.MsgConvertCoinToERC20")
	proto.RegisterType((*MsgConvertCoinToERC20Response)(nil), "black.evmutil.v1beta1.MsgConvertCoinToERC20Response")
	proto.RegisterType((*MsgConvertERC20ToCoin)(nil), "black.evmutil.v1beta1.MsgConvertERC20ToCoin")
	proto.RegisterType((*MsgConvertERC20ToCoinResponse)(nil), "black.evmutil.v1beta1.MsgConvertERC20ToCoinResponse")
	proto.RegisterType((*MsgConvertCosmosCoinToERC20)(nil), "black.evmutil.v1beta1.MsgConvertCosmosCoinToERC20")
	proto.RegisterType((*MsgConvertCosmosCoinToERC20Response)(nil), "black.evmutil.v1beta1.MsgConvertCosmosCoinToERC20Response")
}

func init() { proto.RegisterFile("black/evmutil/v1beta1/tx.proto", fileDescriptor_6e82783c6c58f89c) }
...
func (this *MsgConvertERC20ToCoin) VerboseEqual(that interface{}) error {
	...
	if this.BlackERC20Address != that1.BlackERC20Address {
		return fmt.Errorf("BlackERC20Address this(%v) Not Equal that(%v)", this.BlackERC20Address, that1.BlackERC20Address)
	}
	if !this.Amount.Equal(that1.Amount) {
		return fmt.Errorf("Amount this(%v) Not Equal that(%v)", this.Amount, that1.Amount)
	}
...
func (c *msgClient) ConvertCoinToERC20(ctx context.Context, in *MsgConvertCoinToERC20, opts ...grpc.CallOption) (*MsgConvertCoinToERC20Response, error) {
	...
	err := c.cc.Invoke(ctx, "/black.evmutil.v1beta1.Msg/ConvertCoinToERC20", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertERC20ToCoin(ctx context.Context, in *MsgConvertERC20ToCoin, opts ...grpc.CallOption) (*MsgConvertERC20ToCoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.evmutil.v1beta1.Msg/ConvertERC20ToCoin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertCosmosCoinToERC20(ctx context.Context, in *MsgConvertCosmosCoinToERC20, opts ...grpc.CallOption) (*MsgConvertCosmosCoinToERC20Response, error) {
	...
	err := c.cc.Invoke(ctx, "/black.evmutil.v1beta1.Msg/ConvertCosmosCoinToERC20", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ConvertCoinToERC20_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.evmutil.v1beta1.Msg/ConvertCoinToERC20",
	}
...
func _Msg_ConvertERC20ToCoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.evmutil.v1beta1.Msg/ConvertERC20ToCoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ConvertCosmosCoinToERC20_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.evmutil.v1beta1.Msg/ConvertCosmosCoinToERC20",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.evmutil.v1beta1.Msg",
	...
	Metadata: "black/evmutil/v1beta1/tx.proto",
}
...
func (m *MsgConvertERC20ToCoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if len(m.BlackERC20Address) > 0 {
		i -= len(m.BlackERC20Address)
		copy(dAtA[i:], m.BlackERC20Address)
		i = encodeVarintTx(dAtA, i, uint64(len(m.BlackERC20Address)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Receiver) > 0 {
...
func (m *MsgConvertERC20ToCoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlackERC20Address", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlackERC20Address = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Amount", wireType)
