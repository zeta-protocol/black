...
// source: black/evmutil/v1beta1/conversion_pair.proto
...
type ConversionPair struct {
	...
	BlackERC20Address HexBytes `protobuf:"bytes,1,opt,name=black_erc20_address,json=blackErc20Address,proto3,casttype=HexBytes" json:"black_erc20_address,omitempty"`
...
func init() {
	proto.RegisterType((*ConversionPair)(nil), "black.evmutil.v1beta1.ConversionPair")
	proto.RegisterType((*AllowedCosmosCoinERC20Token)(nil), "black.evmutil.v1beta1.AllowedCosmosCoinERC20Token")
}

func init() {
	proto.RegisterFile("black/evmutil/v1beta1/conversion_pair.proto", fileDescriptor_e1396d08199817d0)
}
...
func (this *ConversionPair) VerboseEqual(that interface{}) error {
	...
	if !bytes.Equal(this.BlackERC20Address, that1.BlackERC20Address) {
...
func (m *ConversionPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BlackERC20Address) > 0 {
		...
		i = encodeVarintConversionPair(dAtA, i, uint64(len(m.BlackERC20Address)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ConversionPair) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BlackERC20Address = append(m.BlackERC20Address[:0], dAtA[iNdEx:postIndex]...)
			if m.BlackERC20Address == nil {
				m.BlackERC20Address = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
