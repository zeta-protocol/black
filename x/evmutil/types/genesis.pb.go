...
// source: black/evmutil/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "black.evmutil.v1beta1.GenesisState")
	proto.RegisterType((*Account)(nil), "black.evmutil.v1beta1.Account")
	proto.RegisterType((*Params)(nil), "black.evmutil.v1beta1.Params")
}

func init() {
	proto.RegisterFile("black/evmutil/v1beta1/genesis.proto", fileDescriptor_d916ab97b8e628c2)
}
