...
`Parameters` define the list of conversion pairs allowed to be converted between Black ERC20 tokens & sdk.Coins, and the list of native cosmos sdk.Coins that are allowed to be converted to ERC20s.
