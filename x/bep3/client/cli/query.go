...
func QueryCalcSwapIDCmd(queryRoute string) *cobra.Command {
	return &cobra.Command{
		...
		Example: "bep3 calc-swapid 0677bd8a303dd981810f34d8e5cc6507f13b391899b84d3c1be6c6045a17d747 black1l0xsq2z7gqd7yly0g40y5836g0appumark77ny bnb1ud3q90r98l3mhd87kswv3h8cgrymzeljct8qn7",
...
Example:
$ bkcli q bep3 swaps --involve=black1l0xsq2z7gqd7yly0g40y5836g0appumark77ny
$ bkcli q bep3 swaps --expiration=280
$ bkcli q bep3 swaps --status=(Open|Completed|Expired)
$ bkcli q bep3 swaps --direction=(Incoming|Outgoing)
$ bkcli q bep3 swaps --page=2 --limit=100
`,
		),
		RunE: func(cmd *cobra.Command, args []string) error {
