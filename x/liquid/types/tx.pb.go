...
// source: black/liquid/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgMintDerivative)(nil), "black.liquid.v1beta1.MsgMintDerivative")
	proto.RegisterType((*MsgMintDerivativeResponse)(nil), "black.liquid.v1beta1.MsgMintDerivativeResponse")
	proto.RegisterType((*MsgBurnDerivative)(nil), "black.liquid.v1beta1.MsgBurnDerivative")
	proto.RegisterType((*MsgBurnDerivativeResponse)(nil), "black.liquid.v1beta1.MsgBurnDerivativeResponse")
}

func init() { proto.RegisterFile("black/liquid/v1beta1/tx.proto", fileDescriptor_738981106e50f269) }
...
func (c *msgClient) MintDerivative(ctx context.Context, in *MsgMintDerivative, opts ...grpc.CallOption) (*MsgMintDerivativeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.liquid.v1beta1.Msg/MintDerivative", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BurnDerivative(ctx context.Context, in *MsgBurnDerivative, opts ...grpc.CallOption) (*MsgBurnDerivativeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.liquid.v1beta1.Msg/BurnDerivative", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MintDerivative_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.liquid.v1beta1.Msg/MintDerivative",
	}
...
func _Msg_BurnDerivative_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.liquid.v1beta1.Msg/BurnDerivative",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.liquid.v1beta1.Msg",
	...
	Metadata: "black/liquid/v1beta1/tx.proto",
}
