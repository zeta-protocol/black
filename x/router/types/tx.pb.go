...
// source: black/router/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgMintDeposit)(nil), "black.router.v1beta1.MsgMintDeposit")
	proto.RegisterType((*MsgMintDepositResponse)(nil), "black.router.v1beta1.MsgMintDepositResponse")
	proto.RegisterType((*MsgDelegateMintDeposit)(nil), "black.router.v1beta1.MsgDelegateMintDeposit")
	proto.RegisterType((*MsgDelegateMintDepositResponse)(nil), "black.router.v1beta1.MsgDelegateMintDepositResponse")
	proto.RegisterType((*MsgWithdrawBurn)(nil), "black.router.v1beta1.MsgWithdrawBurn")
	proto.RegisterType((*MsgWithdrawBurnResponse)(nil), "black.router.v1beta1.MsgWithdrawBurnResponse")
	proto.RegisterType((*MsgWithdrawBurnUndelegate)(nil), "black.router.v1beta1.MsgWithdrawBurnUndelegate")
	proto.RegisterType((*MsgWithdrawBurnUndelegateResponse)(nil), "black.router.v1beta1.MsgWithdrawBurnUndelegateResponse")
}

func init() { proto.RegisterFile("black/router/v1beta1/tx.proto", fileDescriptor_63015631bbbf9425) }
...
func (c *msgClient) MintDeposit(ctx context.Context, in *MsgMintDeposit, opts ...grpc.CallOption) (*MsgMintDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.router.v1beta1.Msg/MintDeposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DelegateMintDeposit(ctx context.Context, in *MsgDelegateMintDeposit, opts ...grpc.CallOption) (*MsgDelegateMintDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.router.v1beta1.Msg/DelegateMintDeposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawBurn(ctx context.Context, in *MsgWithdrawBurn, opts ...grpc.CallOption) (*MsgWithdrawBurnResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.router.v1beta1.Msg/WithdrawBurn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawBurnUndelegate(ctx context.Context, in *MsgWithdrawBurnUndelegate, opts ...grpc.CallOption) (*MsgWithdrawBurnUndelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/black.router.v1beta1.Msg/WithdrawBurnUndelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MintDeposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.router.v1beta1.Msg/MintDeposit",
	}
...
func _Msg_DelegateMintDeposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.router.v1beta1.Msg/DelegateMintDeposit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawBurn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.router.v1beta1.Msg/WithdrawBurn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawBurnUndelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/black.router.v1beta1.Msg/WithdrawBurnUndelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "black.router.v1beta1.Msg",
	...
	Metadata: "black/router/v1beta1/tx.proto",
}
