...
import (
	...
	"github.com/zeta-protocol/black/x/committee/testutil"
	"github.com/zeta-protocol/black/x/committee/types"
)
...
func TestGenesisState_Validate(t *testing.T) {
	...
	addresses := []sdk.AccAddress{
		...
		sdk.AccAddress(crypto.AddressHash([]byte("BlackTest3"))),
		sdk.AccAddress(crypto.AddressHash([]byte("BlackTest4"))),
		sdk.AccAddress(crypto.AddressHash([]byte("BlackTest5"))),
	}
