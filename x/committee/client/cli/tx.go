...
{
	"@type": "/black.committee.v1beta1.CommitteeChangeProposal",
  "title": "A Title",
  "description": "A proposal description.",
  "new_committee": {
    "@type": "/black.committee.v1beta1.MemberCommittee",
    "base_committee": {
      "id": "34",
      "description": "member committee",
      "members": ["black1ze7y9qwdddejmy7jlw4cymqqlt2wh05yhwmrv2"],
      "permissions": [],
...
{
	"@type": "/black.committee.v1beta1.CommitteeDeleteProposal",
  "title": "A Title",
  "description": "A proposal description.",
  "committee_id": "1"
}
