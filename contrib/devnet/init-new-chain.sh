...
#        black1ffv7nhd3z6sych2qpqkk03ec6hzkmufy0r2s4c
# blackvaloper1ffv7nhd3z6sych2qpqkk03ec6hzkmufyz4scd0
...
# black1adkm6svtzjsxxvg7g6rshg6kj9qwej8gwqadqd
...
# black18jz5lyhhy6ncjlyty064kttw93yzaulq7rlptu
...
# black10wlnqzyss4accfqmyxwx5jy5x9nfkwh6qm7n4t
...
# black15tmj37vh7ch504px9fcfglmvx6y9m70646ev8t
...
# Set client chain id
sed -in-place='' 's/chain-id = ""/chain-id = "blacklocalnet_8888-1"/g' $DATA/config/client.toml
...
$BINARY add-genesis-account $validatorKeyName 2000000000ublack,100000000000bnb
...
$BINARY add-genesis-account $faucetKeyName 1000000000ublack,100000000000bnb

evmFaucetKeyName="evm-faucet"
printf "$evmFaucetMnemonic\n" | $BINARY keys add $evmFaucetKeyName --eth --recover
$BINARY add-genesis-account $evmFaucetKeyName 1000000000ublack

userKeyName="user"
printf "$userMnemonic\n" | $BINARY keys add $userKeyName --eth --recover
$BINARY add-genesis-account $userKeyName 1000000000ublack,1000000000usdx

relayerKeyName="relayer"
printf "$relayerMnemonic\n" | $BINARY keys add $relayerKeyName --eth --recover
$BINARY add-genesis-account $relayerKeyName 1000000000ublack

# Create a delegation tx for the validator and add to genesis
$BINARY gentx $validatorKeyName 1000000000ublack --keyring-backend test --chain-id $chainID
$BINARY collect-gentxs

# Replace stake with ublack
