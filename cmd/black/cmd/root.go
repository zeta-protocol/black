...
import (
	...
	"github.com/zeta-protocol/black/app/params"
	blackclient "github.com/zeta-protocol/black/client"
	"github.com/zeta-protocol/black/migrate"
)

// EnvPrefix is the prefix environment variables must have to configure the app.
const EnvPrefix = "BLACK"

// NewRootCmd creates a new root command for the black blockchain.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "black",
		Short: "Daemon and CLI for the Black blockchain.",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig("ublack")
...
// addSubCmds registers all the sub commands used by black.
